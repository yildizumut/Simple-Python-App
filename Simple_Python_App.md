...
Here in this tutorial, we will create a very simple Python application that can be really useful in various business cases. It will be a simple application, because user can use it through the command prompt window. If you are not looking for fancy GUIs, you can construct your easy-peasy Python application right away and it can make your life a lot easier. You can give up preparing the same analysis over and over again, with different input parameters and save a great deal of your efforts in the long run. Or, if you don't want to share Python code with your non-technical colleague, instead you want to give her/him a simple interface that she/he can work through, this tutorial may help you a lot. After you finish the tutorial, you will be able to easily design a desktop Python application within minutes, which runs through command prompt screen. In work life, you may not want to spend too much time on creating fancy GUIs especially if you are a data scientist. You may want to put more emphasis on modeling phase and deploy your model as soon as it is ready. For small-scale models that handle daily operations at work, the method that we will discuss in the tutorial may help you achieve it.  
